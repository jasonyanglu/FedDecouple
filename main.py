...
def FedPer():
    ...
    for round_i in range(args.num_rounds):
        ...
        for i in selected_clients:
            ...
            avg_test_acc1 += test_acc
        avg_test_acc1 /= len(selected_clients)
        avg_acc1.append(avg_test_acc1)
    ...
    plt.savefig('./save/fedper_{}_{}_{}_C{}_loss.png'.format(args.dataset, args.model, args.num_rounds, args.C))
    ...
    plt.savefig('./save/fedper_{}_{}_{}_C{}_accuracy.png'.format(args.dataset, args.model, args.num_rounds, args.C))
